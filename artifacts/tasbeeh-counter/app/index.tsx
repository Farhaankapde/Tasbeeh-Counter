...
export default function HomeScreen() {
  ...
  return (
    <LinearGradient colors={appState.theme === 'light' ? [palette.background, '#e9e4de', palette.background] : [palette.background, '#171211', palette.background]} start={{ x: 0.1, y: 0 }} end={{ x: 0.9, y: 1 }} style={styles.root}>
      ...
      {activeTab === 'counter' ? appState.dhikrs.length > 0 ? <ScrollView style={styles.counterScroll} showsVerticalScrollIndicator={false} bounces={false} contentContainerStyle={[styles.scrollContent, styles.counterScrollContent, { paddingTop: counterSafeTop + 8, paddingBottom: 104 + Math.max(insets.bottom, 14) }]}>
        ...
        <View style={styles.counterLayer}>
         ...
         <View style={[styles.counterDeviceStage, compactCounter && styles.counterDeviceStageCompact]}><View style={[styles.deviceAmbientGlow, completionFlash && styles.deviceGlowComplete]} /><View style={[styles.deviceSideGlow, styles.deviceSideGlowLeft, completionFlash && styles.deviceGlowComplete]} /><View style={[styles.deviceSideGlow, styles.deviceSideGlowRight, completionFlash && styles.deviceGlowComplete]} /><View style={styles.deviceContactShadow} /><HardwareCounter count={currentCount} width={deviceWidth} palette={palette} scale={scale} pressed={pressed} completionFlash={completionFlash} disabled={!hydrated} onPress={increment} onPressIn={() => setPressed(true)} onPressOut={() => setPressed(false)} /></View>
