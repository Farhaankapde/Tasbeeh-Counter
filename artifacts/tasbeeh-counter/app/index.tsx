...
function CounterAtmosphere({ dark }: { dark: boolean }) {
  return <View pointerEvents="none" style={styles.counterAtmosphere}>
    ...
    <View style={[styles.atmosphereGlow, { backgroundColor: dark ? 'rgba(187, 17, 22, 0.18)' : 'rgba(183, 31, 42, 0.08)' }]} />
